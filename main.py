...
def main(config):
    ...
    rtbwe_train = RTBWETrain.load_from_checkpoint("/media/youngwon/Neo/NeoChoi/Projects/RealTimeBWE/logger/RTBWE_logs/version_0/checkpoints/epoch=249-val_pesq_wb=3.56-val_pesq_nb=4.47.ckpt", config = config)
